// TODD :
// 1- Use webpack and import libraries
// 2- add the full version of jQuery to do ajax calls or use react
// 3- Get github repos
// 4- add gifs for apps
// 5- add github links next to repos
// 6- use either jQuery or react to add the projects on the page dynamically maybe
// 7- add a little bio with parrallax effect
...
window.onload = () => {
  ...
  // create the canvas on window load
  const canvasDiv = document.getElementById('particle-canvas');
  const options = {
    particleColor: '#888',
    background: 'assets/imgs/code.jpg',  
    interactive: true,
    speed: 'medium',
    density: 'high'
  };
...
const showTitleTypingOnScroll = function (){
  $(window).scroll(function() {
    if ($(this).scrollTop() > 120){
      $('#welcomeTitle').addClass('typingText');
    }
  });
}
